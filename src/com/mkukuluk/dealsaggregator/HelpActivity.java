...
//                "text/html", "UTF-8");
        String helpText =  "<!DOCTYPE html><html><body><font face=\"verdana\" color=\"white\">This app pulls the latest deals from several sites and displays them in a simple list." +
                "<br/><br/><br/>Selecting by touching will launch that deal\'s webpage, and hitting the \"Back\" button will get you back to the app page. You can select the deal sites by going to " +
